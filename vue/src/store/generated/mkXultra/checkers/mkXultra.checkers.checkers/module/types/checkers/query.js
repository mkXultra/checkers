...
export class QueryClientImpl {
    ...
    NextGame(request) {
        ...
        const promise = this.rpc.request("mkXultra.checkers.checkers.Query", "NextGame", data);
    ...
    StoredGame(request) {
        ...
        const promise = this.rpc.request("mkXultra.checkers.checkers.Query", "StoredGame", data);
    ...
    StoredGameAll(request) {
        ...
        const promise = this.rpc.request("mkXultra.checkers.checkers.Query", "StoredGameAll", data);
    ...
    Leaderboard(request) {
        ...
        const promise = this.rpc.request("mkXultra.checkers.checkers.Query", "Leaderboard", data);
