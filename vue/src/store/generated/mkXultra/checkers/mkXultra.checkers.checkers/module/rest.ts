...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/mkXultra/checkers/checkers/playerInfo
   */
  queryPlayerInfoAll = (
    query?: {
    ...
    this.request<CheckersQueryAllPlayerInfoResponse, RpcStatus>({
      path: `/mkXultra/checkers/checkers/playerInfo`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/mkXultra/checkers/checkers/storedGame
   */
  queryStoredGameAll = (
    query?: {
      "pagination.key"?: string;
    ...
    this.request<CheckersQueryAllStoredGameResponse, RpcStatus>({
      path: `/mkXultra/checkers/checkers/storedGame`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
