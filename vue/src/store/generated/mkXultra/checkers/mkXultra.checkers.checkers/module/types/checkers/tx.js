...
export class MsgClientImpl {
    ...
    CreateGame(request) {
        ...
        const promise = this.rpc.request("mkXultra.checkers.checkers.Msg", "CreateGame", data);
        return promise.then((data) => MsgCreateGameResponse.decode(new Reader(data)));
    }
    PlayMove(request) {
        const data = MsgPlayMove.encode(request).finish();
        const promise = this.rpc.request("mkXultra.checkers.checkers.Msg", "PlayMove", data);
        return promise.then((data) => MsgPlayMoveResponse.decode(new Reader(data)));
    }
    RejectGame(request) {
        const data = MsgRejectGame.encode(request).finish();
        const promise = this.rpc.request("mkXultra.checkers.checkers.Msg", "RejectGame", data);
        return promise.then((data) => MsgRejectGameResponse.decode(new Reader(data)));
    }
    CreatePost(request) {
        const data = MsgCreatePost.encode(request).finish();
        const promise = this.rpc.request("mkXultra.checkers.checkers.Msg", "CreatePost", data);
